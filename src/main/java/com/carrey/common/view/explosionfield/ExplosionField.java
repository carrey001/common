 ...
 */
package com.carrey.common.view.explosionfield;
...
//                ViewHelper.setTranslationX(view, (random.nextFloat() - 0.5f) * view.getWidth() * 0.05f);
//                ViewHelper.setTranslationY(view, (random.nextFloat() - 0.5f) * view.getHeight() * 0.05f);

            }
        });
        animator.start();
//        ViewPropertyAnimator.animate(view).setDuration(150).setStartDelay(startDelay).scaleX(0f).scaleY(0f).alpha(0f).start();
